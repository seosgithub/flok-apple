...
@property (nonatomic, weak) UIView * __null_unspecified rootView;
...
- (void)didReceiveEvent:(NSString * __nonnull)name info:(NSDictionary<NSString *, id> * __nonnull)info;
- (void)send:(NSString * __nonnull)name withInfo:(NSDictionary<NSString *, id> * __nonnull)info;
@end
